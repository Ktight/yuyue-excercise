...
def main():
    ...
    phase_two_schemas = {
        ...
        'class-records/list.success.json': 'ClassRecordListSuccessResponse',
        'class-records/detail.success.json': 'ClassRecordSuccessResponse',
        'class-records/create.request.json': 'ClassRecordCreateRequest',
        'class-records/create.success.json': 'ClassRecordSuccessResponse',
        ...
        'class-media/detail.success.json': 'ClassMediaSuccessResponse',
        'class-media/create.request.json': 'ClassMediaCreateRequest',
        'class-media/create.success.json': 'ClassMediaSuccessResponse',
        'class-media/update.request.json': 'ClassMediaUpdateRequest',
        'class-media/update.success.json': 'ClassMediaSuccessResponse',
        'class-media/upload.success.json': 'FileUploadSuccessResponse',
        'class-templates/list.success.json': 'ClassTemplateListSuccessResponse',
        'class-templates/detail.success.json': 'ClassTemplateSuccessResponse',
        'class-templates/create.request.json': 'ClassTemplateCreateRequest',
